...
from palme.optimizer import get_optimizer
from palme.palm import PaLM
from palme.reward import RewardModel
from palme.utils import eval_decorator, masked_mean
    ...
    def train(
        ...
        for eps in tqdm(range(num_episodes), desc = 'episodes'):
            for timestep in range(max_timesteps):
                ...
                def detach_to_cpu_(t):
                    return rearrange(t.detach().cpu(), '1 ... -> ...')
